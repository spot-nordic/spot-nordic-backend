...
export const orderStatusEnum = pgEnum('order_status', ['PENDING', 'PENDING_BANK_TRANSFER', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED']);
...
export const newsletterStatusEnum = pgEnum('newsletter_status', ['DRAFT', 'SENT', 'FAILED']);